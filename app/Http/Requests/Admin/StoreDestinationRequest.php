...
class StoreDestinationRequest extends FormRequest
{
        ...
        return $this->baseRules() + [
            'slug' => [
                ...
                Rule::unique('slugs', 'slug')
                    ->where(fn ($query) => $query->where('locale', app()->getLocale())),
            ],
        ];
    }
    ...
    protected function baseRules(): array
    {
        return [
            ...
            'type' => ['required', 'in:'.implode(',', array_keys(DestinationTreeService::TYPES))],
            'market' => ['required', 'in:'.implode(',', array_keys(DestinationTreeService::MARKETS))],
            ...
            'submit_action' => [
                'nullable',
                'in:save_and_create,quick_create,quick_create_another',
            ],
            'form_context' => ['nullable', 'in:quick_destination'],
        ];
    }
}
