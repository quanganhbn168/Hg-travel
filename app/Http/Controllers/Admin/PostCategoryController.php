...
class PostCategoryController extends Controller
{
    ...
    public function index(IndexPostCategoryRequest $request): View
    {
        return view(
            ...
            $this->postCategoryService->indexContext($request->validated()),
        );
    }

    public function create(): View
    {
        return view('admin.post_categories.create', $this->postCategoryService->formContext());
    }

    public function store(StorePostCategoryRequest $request): RedirectResponse
    {
        $category = $this->postCategoryService->create($request->validated());

        return redirect()
            ->route('admin.post-categories.edit', $category)
    ...
    public function edit(PostCategory $postCategory): View
    {
        return view(
            ...
            $this->postCategoryService->formContext($postCategory),
        );
    }
    ...
    public function destroy(PostCategory $postCategory): RedirectResponse
    {
        ...
        return back()->with('success', 'Đã đưa danh mục vào thùng rác.');
    }
}
