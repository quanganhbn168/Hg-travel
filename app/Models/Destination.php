...
class Destination extends Model implements HasMedia
{
    ...
    {
        return ['latitude' => 'decimal:7', 'longitude' => 'decimal:7', 'is_featured' => 'boolean', 'is_active' => 'boolean', 'is_system' => 'boolean', 'landing_enabled' => 'boolean'];
    }
    ...
    {
        return $this->belongsToMany(Tour::class, 'destination_tour')->withPivot('sort_order', 'is_primary')->withTimestamps();
    }
