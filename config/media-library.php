...
use App\Support\ManagedMediaPathGenerator;
...
return [
     ...
     */
    // Absolute ceiling only; MediaPolicy enforces the administrator's 1-100 MB limit.
     ...
     */
    'path_generator' => ManagedMediaPathGenerator::class,
