...
<style>
    ...
    .product-gallery-primary-badge {
        ...
        padding: 5px 9px;
        border-radius: 999px;
        color: var(--hg-surface-raised);
        background: var(--hg-primary-overlay);
        font-size: .75rem;
        font-weight: 700;
        box-shadow: 0 4px 14px var(--hg-shadow);
    }
    ...
    .product-gallery-dropzone {
        ...
        min-height: 148px;
        padding: 24px;
        border: 2px dashed var(--hg-primary-border) !important;
        border-radius: 12px;
        background: linear-gradient(135deg, var(--hg-primary-wash), var(--hg-accent-wash));
        cursor: pointer;
    }
    .product-gallery-dropzone:hover,
    .product-gallery-dropzone.dz-drag-hover {
        border-color: var(--bs-primary) !important;
        background: var(--hg-primary-wash-strong);
    }
