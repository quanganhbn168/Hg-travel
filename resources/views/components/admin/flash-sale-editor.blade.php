...
<style>
    ...
    .flash-sale-item { overflow: hidden; border: 1px solid var(--bs-border-color); border-radius: .7rem; background: var(--bs-body-bg); box-shadow: 0 1px 2px var(--hg-shadow); }
    ...
    .flash-sale-editor-product img, .flash-sale-picker-product img { flex: 0 0 auto; object-fit: cover; border: 1px solid var(--bs-border-color); border-radius: .45rem; background: var(--hg-surface-raised); }
