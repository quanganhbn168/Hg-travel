...
<style>
    ...
    .media-card:hover {
        ...
        box-shadow: 0 .5rem 1rem var(--hg-shadow) !important;
    ...
    .media-card-overlay {
        ...
        width: 100%;
        height: 100%;
        background: var(--hg-primary-overlay);
        opacity: 0;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderTabGrid(key, containerId, searchQuery = '') {
            ...
            if (filteredItems.length === 0) {
                container.innerHTML = '<div class="col-12 py-5 text-center"><i class="bi bi-image" style="font-size: 2.5rem; color: var(--bs-secondary-color);"></i><p class="text-muted mt-2 mb-0">Không tìm thấy hình ảnh nào phù hợp.</p></div>';
                return;
            }
            ...
            <div class="modal-body pt-3">
                ...
                <div class="tab-content" id="mediaManagerTabContent">
                    ...
                    <div class="tab-pane fade" id="panel-upload" role="tabpanel">
                        <div id="mediaManagerDropzone" class="dropzone border-dashed border-2 rounded p-5 text-center cursor-pointer bg-light d-flex flex-column align-items-center justify-content-center" style="border-color: var(--bs-primary) !important; min-height: 250px;">
                            <div class="dz-message py-4">
                                <i class="bi bi-cloud-arrow-up text-success" style="font-size: 3.5rem;"></i>
                                <h5 class="mt-3 font-weight-bold">Kéo thả ảnh vào đây hoặc bấm để chọn tệp tin</h5>
                                <p class="text-muted text-sm mb-0">Ảnh tải lên tại đây sẽ được tối ưu tự động và chuyển vào Thư mục Editor</p>
